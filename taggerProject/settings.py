...
INSTALLED_APPS = [
    ...
    # https://www.vinta.com.br/blog/2017/how-make-sure-celery-beat-tasks-are-working/ -- celerybeat status
    'celerybeat_status'
    # 'filepopulator',
]
...
WSGI_APPLICATION = 'taggerProject.wsgi.application'
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis_django://redis:6379/0",
        "OPTIONS": {
